...
class SWFData : BitArray() {
	...
	fun readFLOAT16(): Double = Half.intBitsToFloat(resetBitsPending().readUnsignedShort().toUShort()).toDouble()
	fun writeFLOAT16(value: Double) = resetBitsPending().writeShort(Half.floatToIntBits(value.toFloat()).toInt())
