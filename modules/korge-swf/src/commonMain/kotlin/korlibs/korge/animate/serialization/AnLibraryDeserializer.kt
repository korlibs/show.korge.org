...
import korlibs.korge.animate.AnPlaySoundAction
import korlibs.korge.animate.AnSymbol
import korlibs.korge.animate.AnSymbolBitmap
import korlibs.korge.animate.AnSymbolEmpty
import korlibs.korge.animate.AnSymbolLimits
import korlibs.korge.animate.AnSymbolMorphShape
import korlibs.korge.animate.AnSymbolMovieClip
import korlibs.korge.animate.AnSymbolMovieClipState
import korlibs.korge.animate.AnSymbolMovieClipSubTimeline
import korlibs.korge.animate.AnSymbolShape
import korlibs.korge.animate.AnSymbolSound
import korlibs.korge.animate.AnSymbolTimelineFrame
import korlibs.korge.animate.AnSymbolUidDef
import korlibs.korge.animate.AnTextFieldSymbol
import korlibs.korge.animate.Timed
import korlibs.korge.animate.animateLibraryLoaders
...
object AnLibraryDeserializer {
			...
			AniFile.SYMBOL_TYPE_SHAPE -> {
				...
				AnSymbolShape(
					...
					textureWithBitmap = TextureWithBitmapSlice(
						texture = texture.slice(textureBounds.immutable),
						bitmapSlice = bitmap.slice(textureBounds.immutable),
						scale = scale,
						bounds = bounds.immutable
					),
					path = path
				)
			}
	...
	fun FastByteArrayInputStream.readRect(): MRectangle =
		MRectangle(x = readS_VL() / 20.0, y = readS_VL() / 20.0, width = readS_VL() / 20.0, height = readS_VL() / 20.0)

	fun FastByteArrayInputStream.readIRect(): MRectangleInt =
		MRectangleInt(x = readS_VL(), y = readS_VL(), width = readS_VL(), height = readS_VL())
}
