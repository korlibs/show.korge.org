...
import korlibs.datastructure.BitSet
import korlibs.datastructure.memoize
...
import korlibs.korge.view.filter.composedOrNull
...
class SymbolAnalyzeInfo(val characterId: Int) {
	...
	fun registerMatrix(matrix: MMatrix) {
...
class SWFShapeRasterizerRequest constructor(
    ...
    val shapeBounds: MRectangle get() = tag.shapeBounds.rect
	val path = VectorPath()
			...
			fun toFrameElement() = AnSymbolTimelineFrame(
                ...
                filter = filterList.mapNotNull { when (it) {
                    is FilterBlur -> {
                        ...
                        ComposedFilter(BlurFilter(blurAmount.toFloat(), optimize = false))
                        //ComposedFilter(BlurFilter(blurAmount, optimize = true))
                        //ComposedFilter(BlurFilter(blurAmount, optimize = true))
                        //ComposedFilter(BlurFilter(blurAmount, optimize = false))
                    }
                    is FilterDropShadow -> {
                        DropshadowFilter(it.blurX.toFloat(), it.blurY.toFloat(), decodeSWFColor(it.dropShadowColor), blurRadius = computeBlur(it.distance, it.passes).toFloat())
                    }
                    else -> {
                ...
                */
				...
				is TagPlaceObject -> {
					...
					if (it.hasBlendMode) depth.blendMode = when (it.blendMode) {
						korlibs.korfl.as3swf.BlendMode.NORMAL_0 -> BlendMode.NORMAL
						korlibs.korfl.as3swf.BlendMode.NORMAL_1 -> BlendMode.NORMAL
						korlibs.korfl.as3swf.BlendMode.LAYER -> BlendMode.INHERIT
						korlibs.korfl.as3swf.BlendMode.MULTIPLY -> BlendMode.MULTIPLY
						korlibs.korfl.as3swf.BlendMode.SCREEN -> BlendMode.SCREEN
						korlibs.korfl.as3swf.BlendMode.LIGHTEN -> BlendMode.LIGHTEN
						korlibs.korfl.as3swf.BlendMode.DARKEN -> BlendMode.DARKEN
						korlibs.korfl.as3swf.BlendMode.DIFFERENCE -> BlendMode.DIFFERENCE
						korlibs.korfl.as3swf.BlendMode.ADD -> BlendMode.ADD
						korlibs.korfl.as3swf.BlendMode.SUBTRACT -> BlendMode.SUBTRACT
						korlibs.korfl.as3swf.BlendMode.INVERT -> BlendMode.INVERT
						korlibs.korfl.as3swf.BlendMode.ALPHA -> BlendMode.ALPHA
						korlibs.korfl.as3swf.BlendMode.ERASE -> BlendMode.ERASE
						//korlibs.korfl.as3swf.BlendMode.OVERLAY ->  BlendMode.OVERLAY
						korlibs.korfl.as3swf.BlendMode.OVERLAY -> BlendMode.INHERIT
						korlibs.korfl.as3swf.BlendMode.HARDLIGHT -> BlendMode.HARDLIGHT
