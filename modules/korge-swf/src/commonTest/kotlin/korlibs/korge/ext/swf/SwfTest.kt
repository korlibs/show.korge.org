...
import korlibs.korfl.as3swf.SWF
import korlibs.korfl.as3swf.TagDefineShape
import korlibs.korge.animate.serialization.readAni
import korlibs.korge.animate.serialization.writeTo
import korlibs.korge.tests.TestCoroutineDispatcher
import korlibs.korge.view.Container
import korlibs.korge.view.View
import korlibs.korge.view.Views
import korlibs.korge.view.ViewsLog
import korlibs.korge.view.allDescendantNames
import korlibs.korge.view.dumpToString
import korlibs.korge.view.updateSingleView
import korlibs.image.vector.ShapeRasterizerMethod
...
class SwfTest {
    ...
    @Test
    fun dog() = swfTest {
        if (Platform.isAndroid) return@swfTest
