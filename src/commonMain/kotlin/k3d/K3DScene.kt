...
class K3DScene : ShowScene() {
    ...
    override suspend fun SContainer.sceneMain() {
        scene3D {
            ...
            gltf2View(resourcesVfs["k3d/Gest.glb"].readGLTF2()).position(2, 0, 0)
            ...
            fun rotate(deltaY: Angle, deltaX: Angle) {
                koralView.rotation(quat * Quaternion.fromAxisAngle(Vector3.UP, rotationY) * Quaternion.fromAxisAngle(
                    Vector3.RIGHT, rotationX))
                rotationY += deltaY
                rotationX += deltaX
            }
